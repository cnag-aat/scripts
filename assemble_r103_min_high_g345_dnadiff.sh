...
if [ ! -f $BASE.flye.racon.medaka.fasta ]; then
    ...
    medaka_consensus -t $THREADS -m r103_min_high_g345 -i $READS -d $BASE.flye.racon1.racon2.fasta -o $TMPDIR/$BASE.flye.racon1.racon2.medaka;  cp -r $TMPDIR/$BASE.flye.racon1.racon2.medaka .; rm -r $TMPDIR/$BASE.flye.racon1.racon2.medaka
